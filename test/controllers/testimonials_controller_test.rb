...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { address: @testimonial.address, comment: @testimonial.comment, name: @testimonial.name }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { address: @testimonial.address, comment: @testimonial.comment, name: @testimonial.name }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
